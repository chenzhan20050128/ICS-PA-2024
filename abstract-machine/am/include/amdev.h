...
AM_DEVREG(15, AUDIO_CTRL, WR, int freq, channels, samples); // 采样率，channels,每次周期缓冲区大小
...
/*展开之后，AM_KEYS(AM_KEY_NAMES) 的结果如下：
enum {
  AM_KEY_NONE = 0,
  AM_KEY_ESCAPE,
  AM_KEY_F1, AM_KEY_F2, AM_KEY_F3, ..., AM_KEY_PAGEDOWN

};
自动生成键值枚举，从而简化了代码的编写和管理*/
