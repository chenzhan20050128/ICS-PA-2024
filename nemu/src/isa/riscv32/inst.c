...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */)         \
  ...
  INSTPAT("0000001 ????? ????? 001 ????? 0110011", mulh, R, R(rd) = BITS(((int64_t)src1 * (int64_t)src2), 63, 32));
  INSTPAT("0000001 ????? ????? 010 ????? 0110011", mulhsu, R, R(rd) = BITS(((int64_t)src1 * (uint64_t)src2), 63, 32));
